...
$sum = 0;
$temp = $number;
$digits = strlen((string)$number); // Count digits

while ($temp > 0) {
    $digit = $temp % 10;
    $sum += pow($digit, $digits); // Raise each digit to power of digits
    $temp = (int)($temp / 10);
}
...
<!-- Validate Email Address Using Built-in Functions -->
